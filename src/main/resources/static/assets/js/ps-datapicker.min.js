!function (t) {
    ...
    e.PSdatapicker = n;
    var o, l = s(0);
    (o = e.MyModule || (e.MyModule = {})).PSdatapicker = l.PSdatapicker, window.PSdatapicker = o.PSdatapicker, e.default = n
}, function (t, e, s) {
    "use strict";
    Object.defineProperty(e, "__esModule", {value: !0}), e.CSS_CLASSES = {
        CALENDAR: "ps-datapicker",
        MONTH: "month",
        DAY: "day",
        WEEK: "week",
    ...
    var i = function () {
        ...
        return t.timestampToHuman = function (t, e, s) {
            var i = new Date(t);
            return (e = (e = (e = (e = (e = (e = (e = (e = (e = e.replace("dd", i.getDate().toString())).replace("DD", (i.getDate() > 9 ? i.getDate() : "0" + i.getDate()).toString())).replace("mm", (i.getMonth() + 1).toString())).replace("MMM", s.months[i.getMonth()])).replace("MM", (i.getMonth() + 1 > 9 ? i.getMonth() + 1 : "0" + (i.getMonth() + 1)).toString())).replace("mmm", s.monthsShort[i.getMonth()])).replace("yyyy", i.getFullYear().toString())).replace("YYYY", i.getFullYear().toString())).replace("YY", i.getFullYear().toString().substring(2))).replace("yy", i.getFullYear().toString().substring(2))
            ...
            return a || ((a = document.createElement("div")).classList.add(e), null !== i && (a.innerHTML = i), s.appendChild(a)), a
